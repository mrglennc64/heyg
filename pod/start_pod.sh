...
echo "=== 3. start render service on 127.0.0.1:8000 ==="
pkill -f "uvicorn.*render_service" 2>/dev/null || true
cd /workspace
nohup uvicorn render_service:app --host 127.0.0.1 --port 8000 > /workspace/render_service.log 2>&1 &
sleep 6
